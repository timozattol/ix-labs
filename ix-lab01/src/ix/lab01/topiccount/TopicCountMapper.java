...
import ix.utils.SimpleDateTime;
 ...
 *
 */
public class TopicCountMapper extends Mapper<LongWritable, // input key: line offset
    ...
    public void map(LongWritable inputKey, Text inputValue, Context context)
        ...
        if (!tweet.createdAt.isSameDay(new SimpleDateTime(2012, 9, 6, 0, 0, 0))) {
        	return;
        }
