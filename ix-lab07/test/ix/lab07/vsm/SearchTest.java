...
import ix.utils.DocumentTokenization;
...
public class SearchTest {
    ...
    public void testSearchReducer() throws IOException {
        ...
        ReduceDriver<IntWritable, Text, IntWritable, DoubleWritable> driver =
                ReduceDriver.newReduceDriver(new SearchReducer()).withInput(inputKey, inputValues);
        driver.getConfiguration().set("queryTokens", tokens);

        Pair<IntWritable, DoubleWritable> output = Iterables.getOnlyElement(driver.run());
